package com.lpc.service.adapter.Impl;
...
@Slf4j
@Service
public class YinLianPay implements PayAdapterService {
	...
	private String setPay(PaymentType paymentType, PaymentInfo paymentInfo) {
		...
		requestData.put("txnAmt", String.valueOf(paymentInfo.getPrice()*100)); // 交易金额，单位分，不要带小数点
