...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#message_FIND_PASSWORD").click(function(){
                if(validate()){
                    $("#miniFind").attr("action","findPassword");
                    $("#miniFind").submit();
                }
            });
        });
                ...
                <form method="post" id="miniFind">
                    <div class="shake-area" id="shake_area" style="z-index: 30;">
                        ...
                        <div class="enter-area" style="z-index: 20;">
                            <input type="text" name="email" class="enter-item last-enter-item" id="miniFind_email"
                                   autocomplete="off" placeholder="邮箱">
                        </div>
                    </div>

                    <input class="button orange" type="button" id="message_FIND_PASSWORD" value="找回密码">
