...
<div id="user-b">
    ...
    <section class="m-component-user" id="m-user">
        <div class="m-user-avatar text-center">
            ...
            <#else>
                <div class="user_btn">
                    <a href="http://28ii870524.zicp.vip/mobile-web/toLogin" class="this">登录</a>
                    <a href="http://28ii870524.zicp.vip/mobile-web/toRegister">注册</a>
                </div>
            </#if>
        </div>
        ...
        <div class="head_list">
            <ul class="m-user-list">
                <#if username?exists>
                    <li><a href="http://28ii870524.zicp.vip/cart-web/selectCart"><span>${cartSize}</span><br>我的购物车</a></li>
                    <li><a href="http://28ii870524.zicp.vip/order-web/selectUserAllOrder"><span>${orderSize}</span><br>我的订单</a></li>
                <#else>
                    <li><a href="javascript:void(0)" onclick="gogo()"><span>0</span><br>我的购物车</a></li>
        ...
        <ul class="m-user-content">
            <li>
                <div class="m-user-item">
                    <a href="http://28ii870524.zicp.vip/usercenter-web/toUpdateUser" class="user-set">修改信息</a>
                </div>
                <div class="m-user-item">
